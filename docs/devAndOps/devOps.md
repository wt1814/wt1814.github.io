...
- [1. CI/CD与Devops](#1-cicd与devops)
    ...
    - [1.2. DevOps](#12-devops)
        ...
        - [1.2.2. 流程](#122-流程)
        - [1.2.3. 工具集](#123-工具集)
    - [1.3. CI/CD流程](#13-cicd流程)
    - [1.4. 持续集成](#14-持续集成)
        - [1.4.1. CI：代码提交阶段](#141-ci代码提交阶段)
        - [1.4.2. CI：静态代码检查阶段](#142-ci静态代码检查阶段)
        - [1.4.3. CI：构建](#143-ci构建)
        - [1.4.4. CI：测试阶段](#144-ci测试阶段)
    - [1.5. 持续部署：Bake和部署](#15-持续部署bake和部署)
        - [1.5.1. CD：Bake](#151-cdbake)
        - [1.5.2. CD：部署](#152-cd部署)
        - [1.5.3. CD：验证](#153-cd验证)
        - [1.5.4. CD：监控](#154-cd监控)
    - [1.6. 持续交付（CD）：反馈和协作工具](#16-持续交付cd反馈和协作工具)
