...
- [1. k8s安装应用](#1-k8s安装应用)
    - [1.1. ***K8S Pod Pending 故障原因及解决方案](#11-k8s-pod-pending-故障原因及解决方案)
    - [1.2. 安装应用](#12-安装应用)
    - [1.3. k8s的yaml文件配置详解](#13-k8s的yaml文件配置详解)
    - [1.4. ★★★资源限制](#14-★★★资源限制)
    - [1.5. 零停机滚动更新](#15-零停机滚动更新)
        - [1.5.1. 滚动发布升级时，延迟销毁容器（更优雅的升级）](#151-滚动发布升级时延迟销毁容器更优雅的升级)
    - [1.6. 自动扩缩容](#16-自动扩缩容)
    - [1.7. Pod污点与容忍](#17-pod污点与容忍)
