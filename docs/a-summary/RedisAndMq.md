    ...
    - [1.3. 分布式消息队列](#13-分布式消息队列)
        ...
        - [1.3.2. Kafka](#132-kafka)
            ...
            - [1.3.2.2. kafka特性](#1322-kafka特性)
                - [1.3.2.2.1. 【1】高性能(读写机制) ，Kafka为什么吞吐量大、速度快？](#13221-1高性能读写机制-kafka为什么吞吐量大速度快)
                    - [1.3.2.2.1.1. 内存](#132211-内存)
                    - [1.3.2.2.1.2. 持久化 / 磁盘IO - 顺序读写](#132212-持久化--磁盘io---顺序读写)
                    - [1.3.2.2.1.3. 网络IO优化](#132213-网络io优化)
                - [1.3.2.2.2. 【2】高可用与数据一致性(副本机制)](#13222-2高可用与数据一致性副本机制)
                - [1.3.2.2.3. ~~可靠性~~](#13223-可靠性)
                    - [1.3.2.2.3.1. 如何保证消息队列不丢失?](#132231-如何保证消息队列不丢失)
                    - [1.3.2.2.3.2. 分区保证消费顺序](#132232-分区保证消费顺序)
                    - [1.3.2.2.3.3. 消费语义介绍](#132233-消费语义介绍)
                    - [1.3.2.2.3.4. 幂等（重复消费）](#132234-幂等重复消费)
                    - [1.3.2.2.3.5. 事务](#132235-事务)
...
##### 1.3.2.2.1. 【1】高性能(读写机制) ，Kafka为什么吞吐量大、速度快？
