...
## 1.4. 布谷鸟过滤器算法  
![image](https://gitee.com/wt1814/pic-host/raw/master/images/structure/structure-1.png)  
...
&emsp; 删除不完美，存在误删的概率。删除的时候知识删除了一份指纹副本，并不能确定此指纹副本是要删除的key的指纹。同时这个问题也导致了假阳性的情况。
