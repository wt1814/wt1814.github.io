...
- [1. Java基础](#1-java基础)
    ...
    - [1.2. 流程控制语句](#12-流程控制语句)
        ...
        - [1.2.5. 扩展](#125-扩展)
        - [1.2.6. 符号](#126-符号)
            - [1.2.6.1. 三元运算符](#1261-三元运算符)
            - [1.2.6.2. 通配符](#1262-通配符)
            - [1.2.6.3. 占位符](#1263-占位符)
        - [1.2.7. 优化if/else](#127-优化ifelse)
    - [1.3. Java关键字](#13-java关键字)
    - [1.4. Java变量](#14-java变量)
        - [1.4.1. 声明、初始化、实例化](#141-声明初始化实例化)
        - [1.4.2. 全局变量、成员变量、局部变量](#142-全局变量成员变量局部变量)
        - [1.4.3. Java类创建对象时初始化顺序](#143-java类创建对象时初始化顺序)
    - [1.5. Java方法](#15-java方法)
        - [1.5.1. 方法重载](#151-方法重载)
        - [1.5.2. 方法重写](#152-方法重写)
        - [1.5.3. 可变参数](#153-可变参数)
        - [1.5.4. ★★★值传递还是引用传递？](#154-★★★值传递还是引用传递)
            - [1.5.4.1. 基本类型](#1541-基本类型)
            - [1.5.4.2. 引用类型](#1542-引用类型)
    - [1.6. Java类、接口、抽象类](#16-java类接口抽象类)
        - [1.6.1. 抽象类](#161-抽象类)
            - [1.6.1.1. 抽象类作为方法参数与返回值](#1611-抽象类作为方法参数与返回值)
        - [1.6.2. 接口](#162-接口)
            - [1.6.2.1. 接口作为方法参数与返回值](#1621-接口作为方法参数与返回值)
        - [1.6.3. ※※※抽象类和接口的应用](#163-※※※抽象类和接口的应用)
    - [1.7. Java内部类](#17-java内部类)
    - [1.8. Java面向对象的三大特性](#18-java面向对象的三大特性)
        - [1.8.1. 封装](#181-封装)
        - [1.8.2. 继承](#182-继承)
            - [1.8.2.1. super与this关键字](#1821-super与this关键字)
        - [1.8.3. 多态](#183-多态)
...
&emsp; 按值传递：方法调用时，实际参数把它的值传递给对应的形式参数，**<font color = "red">形参接收的是原始值的一个拷贝，此时内存中存在两个相等的变量。</font>**   
