...
&emsp; 递归比较容易造成栈溢出，所以如果有其他时间/空间复杂度相近或更好的算法，应该优先选择非递归的解法,那我们看看如何用迭代来翻转链表，主要思路如下  
...
![image](https://gitee.com/wt1814/pic-host/raw/master/images/java/function/function-19.png)  
