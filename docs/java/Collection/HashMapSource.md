...
- [1. HashMap源码](#1-hashmap源码)
    ...
    - [1.2. 属性(数据结构)](#12-属性数据结构)
        ...
        - [1.2.4. 树形化结构](#124-树形化结构)
            - [1.2.4.1. 为什么使用红黑树？](#1241-为什么使用红黑树)
            - [1.2.4.2. 树形化结构](#1242-树形化结构)
...
2. HashMap成员方法：  
    ...
    3. put()中，最后流程扩容机制：JDK 1.8扩容条件是数组长度大于阈值或链表转为红黑树且数组元素小于64时。  
...
<!-- 
https://blog.csdn.net/weixin_49698553/article/details/125448394
-->
