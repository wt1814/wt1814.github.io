...
- [1. 重要的垃圾收集器](#1-重要的垃圾收集器)
    - [1.1. CMS](#11-cms)
        ...
        - [1.1.3. ~~concurrent mode failure & promotion failed问题~~](#113-concurrent-mode-failure--promotion-failed问题)
            - [1.1.3.1. 简介](#1131-简介)
            - [1.1.3.2. 可能原因及解决方案](#1132-可能原因及解决方案)
    - [1.2. G1](#12-g1)
...
### 1.1.3. ~~concurrent mode failure & promotion failed问题~~
<!-- 
