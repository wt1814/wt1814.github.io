...
- [3. 垃圾回收器](#3-垃圾回收器)
    - [3.1. 收集器分类](#31-收集器分类)
    - [3.2. 收集器详解](#32-收集器详解)
        - [3.2.1. 新生代收集器](#321-新生代收集器)
            - [3.2.1.1. Serial收集器](#3211-serial收集器)
            - [3.2.1.2. ParNew收集器](#3212-parnew收集器)
            - [3.2.1.3. Parallel Scavenge收集器](#3213-parallel-scavenge收集器)
        - [3.2.2. 老年代收集器](#322-老年代收集器)
            - [3.2.2.1. Serial Old收集器](#3221-serial-old收集器)
            - [3.2.2.2. Parallel Old收集器](#3222-parallel-old收集器)
            - [3.2.2.3. CMS收集器](#3223-cms收集器)
        - [3.2.3. G1收集器](#323-g1收集器)
            - [3.2.3.1. G1的内存布局](#3231-g1的内存布局)
            - [3.2.3.2. G1运行流程](#3232-g1运行流程)
            - [3.2.3.3. G1优缺点](#3233-g1优缺点)
            - [3.2.3.4. 使用G1](#3234-使用g1)
        - [3.2.4. 常用的收集器组合](#324-常用的收集器组合)
        - [3.2.5. ZGC](#325-zgc)
        - [3.2.6. Epsilon](#326-epsilon)
        - [3.2.7. Shenandoah](#327-shenandoah)
    - [3.3. 选择合适的垃圾收集器](#33-选择合适的垃圾收集器)
    - [3.4. ~~垃圾收集器常用参数~~](#34-垃圾收集器常用参数)
...
&emsp; 步骤1：<font color = "red">判断有没有必要执行finalize()方法</font>  
...
&emsp; 步骤2：<font color = "red">如何执行？</font>F-Queue 的队列  
