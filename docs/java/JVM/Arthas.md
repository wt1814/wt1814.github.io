...
![image](http://182.92.69.8:8081/img/java/JVM/JVM-146.png)  
...
![image](http://182.92.69.8:8081/img/java/JVM/JVM-160.png)  
...
![image](http://182.92.69.8:8081/img/java/JVM/JVM-147.png)  
...
![image](http://182.92.69.8:8081/img/java/JVM/JVM-148.png)  
...
![image](http://182.92.69.8:8081/img/java/JVM/JVM-149.png)  
...
![image](http://182.92.69.8:8081/img/java/JVM/JVM-150.png)  
...
![image](http://182.92.69.8:8081/img/java/JVM/JVM-151.png)  
![image](http://182.92.69.8:8081/img/java/JVM/JVM-152.png)  
...
![image](http://182.92.69.8:8081/img/java/JVM/JVM-153.png)  
...
![image](http://182.92.69.8:8081/img/java/JVM/JVM-154.png)  
...
![image](http://182.92.69.8:8081/img/java/JVM/JVM-155.png)  
...
![image](http://182.92.69.8:8081/img/java/JVM/JVM-156.png)  
...
![image](http://182.92.69.8:8081/img/java/JVM/JVM-157.png)  
&emsp; 默认情况下，arthas使用3658端口，则可以打开：http://localhost:3658/arthas-output/ 查看到arthas-output目录下面的profiler结果：  
![image](http://182.92.69.8:8081/img/java/JVM/JVM-158.png)  
<center>profiler目录</center>

&emsp; 选择一项点击  
![image](http://182.92.69.8:8081/img/java/JVM/JVM-159.png)  
