...
![image](http://182.92.69.8:8081/img/java/JVM/JVM-94.png)  
1. **全局逃逸(GlobalEscape)**  
...
![image](http://182.92.69.8:8081/img/java/JVM/JVM-114.png)  
&emsp; 使用如下命令执行上述代码  
...
![image](http://182.92.69.8:8081/img/java/JVM/JVM-115.png)  
&emsp; 可以看出，此时堆内存中有2千万个EscapeTest的实例对象(t1和t2各1千万个)，GC日志如下：  
![image](http://182.92.69.8:8081/img/java/JVM/JVM-116.png)  
...
![image](http://182.92.69.8:8081/img/java/JVM/JVM-117.png)  
&emsp; 可以看出此时堆内存中只有30万个左右，并且GC日志如下：  
![image](http://182.92.69.8:8081/img/java/JVM/JVM-118.png)  
...
![image](http://182.92.69.8:8081/img/java/JVM/JVM-119.png)  
...
##### 1.2.2.2.2. 示例
&emsp; 比如以下两个计算和的方法：  
![image](http://182.92.69.8:8081/img/java/JVM/JVM-120.png)  
...
![image](http://182.92.69.8:8081/img/java/JVM/JVM-121.png)  
...
##### 1.2.2.3.2. 示例
&emsp; 比如以下代码：  
![image](http://182.92.69.8:8081/img/java/JVM/JVM-109.png)  
...
![image](http://182.92.69.8:8081/img/java/JVM/JVM-110.png)  
...
![image](http://182.92.69.8:8081/img/java/JVM/JVM-111.png)  
...
![image](http://182.92.69.8:8081/img/java/JVM/JVM-112.png)  
...
![image](http://182.92.69.8:8081/img/java/JVM/JVM-113.png)  
