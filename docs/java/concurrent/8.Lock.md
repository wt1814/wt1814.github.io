...
- [1. java.util.concurrent.locks包](#1-javautilconcurrentlocks包)
    - [1.1. ReentrantLock，重入锁](#11-reentrantlock重入锁)
        - [1.1.1. ReentrantLock解析](#111-reentrantlock解析)
            ...
            - [1.1.1.2. 非公平锁的lock方法](#1112-非公平锁的lock方法)
        - [1.1.2. ReentrantLock的API](#112-reentrantlock的api)
            - [1.1.2.1. 构造函数](#1121-构造函数)
            - [1.1.2.2. 成员方法](#1122-成员方法)
        - [1.1.3. ReentrantLock与synchronized比较](#113-reentrantlock与synchronized比较)
        - [1.1.4. 使用示例](#114-使用示例)
...
#### 1.1.1.2. 非公平锁的lock方法  
&emsp; 调用 ReentrantLock 中的 lock()方法，源码的调用过程时序图：  
...
### 1.1.3. ReentrantLock与synchronized比较 
