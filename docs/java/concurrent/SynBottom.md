...
![image](http://182.92.69.8:8081/img/java/concurrent/multi-57.png)  
简单的加锁解锁过程
...
![image](http://182.92.69.8:8081/img/java/concurrent/multi-12.png)   
...
![image](http://182.92.69.8:8081/img/java/concurrent/multi-13.png)   
...
![image](http://182.92.69.8:8081/img/java/concurrent/multi-14.png)   
&emsp; 在程序运行期间，对象头中锁表标志位会发生改变。Mark Word可能发生的变化如下：  
![image](http://182.92.69.8:8081/img/java/concurrent/multi-15.png)   
...
![image](http://182.92.69.8:8081/img/java/concurrent/multi-69.png)  
