...
* ABA问题（A修改为B，再修改为A）：  
  ...
  &emsp; **<font color = "red">从Java1.5开始JDK的atomic包里提供了一个类</font>**[AtomicStampedReference](/docs/java/concurrent/6.AtomicStampedReference.md) **<font color = "red">来解决ABA问题。</font>**  
