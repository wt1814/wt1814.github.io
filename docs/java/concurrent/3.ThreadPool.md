...
- [1. 线程池](#1-线程池)
    ...
    - [1.2. 线程池框架Executor](#12-线程池框架executor)
        - [1.2.1. 线程池实现](#121-线程池实现)
            ...
            - [1.2.1.3. Executors](#1213-executors)
                - [1.2.1.3.1. SingleThreadExecutor](#12131-singlethreadexecutor)
                - [1.2.1.3.2. FixedThreadPool](#12132-fixedthreadpool)
                - [1.2.1.3.3. CachedThreadPool](#12133-cachedthreadpool)
                - [1.2.1.3.4. ScheduledThreadPool](#12134-scheduledthreadpool)
                - [1.2.1.3.5. 阿里巴巴禁用Executors创建线程池](#12135-阿里巴巴禁用executors创建线程池)
            - [1.2.1.4. Java8使用lamda表达式创建线程池方式](#1214-java8使用lamda表达式创建线程池方式)
...
##### 1.2.1.3.1. SingleThreadExecutor  
...
##### 1.2.1.3.5. 阿里巴巴禁用Executors创建线程池
...
#### 1.2.1.4. Java8使用lamda表达式创建线程池方式
...
### 1.3.2. 确定线程池的大小
<!-- 
https://mp.weixin.qq.com/s/x7WLRHzAE9ZSAigKj5WGLg
-->
