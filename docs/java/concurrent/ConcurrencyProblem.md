...
- [1. 并发问题](#1-并发问题)
    ...
    - [1.2. 重排序](#12-重排序)
        - [1.2.1. 为什么代码会重排序？](#121-为什么代码会重排序)
        - [1.2.2. 指令重排序分类](#122-指令重排序分类)
    ...
    - [1.4. 内存屏障](#14-内存屏障)
        - [1.4.1. 伪共享问题](#141-伪共享问题)
            - [1.4.1.1. CPU缓存架构](#1411-cpu缓存架构)
            - [1.4.1.2. CPU缓存行](#1412-cpu缓存行)
            - [1.4.1.3. 伪共享](#1413-伪共享)
            - [1.4.1.4. 避免伪共享](#1414-避免伪共享)
            - [1.4.1.5. 总结](#1415-总结)
