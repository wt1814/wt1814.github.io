...
## 1.1. ThreadLocal使用  
![image](http://182.92.69.8:8081/img/java/concurrent/multi-54.png)   
...
![image](http://182.92.69.8:8081/img/java/concurrent/multi-19.png)   
...
### 1.1.1. ※※※正确使用  
![image](http://182.92.69.8:8081/img/java/concurrent/multi-20.png)   
...
```
&emsp; 运行结果如下：  
![image](http://182.92.69.8:8081/img/java/concurrent/multi-25.png)   
