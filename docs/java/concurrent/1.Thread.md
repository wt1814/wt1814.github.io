...
- [2. 线程的使用](#2-线程的使用)
    ...
    - [2.2. Thread.java的构造函数](#22-threadjava的构造函数)
    - [2.3. Thread.java的方法](#23-threadjava的方法)
        - [2.3.1. 线程的start方法和run方法的区别](#231-线程的start方法和run方法的区别)
        - [2.3.2. ※※※线程生命周期](#232-※※※线程生命周期)
            - [2.3.2.1. 线程状态介绍](#2321-线程状态介绍)
                - [2.3.2.1.1. 线程有哪几种状态？](#23211-线程有哪几种状态)
                - [2.3.2.1.2. 线程阻塞BLOCKED和等待WAITING的区别](#23212-线程阻塞blocked和等待waiting的区别)
                - [2.3.2.1.3. 线程状态切换图示](#23213-线程状态切换图示)
                - [2.3.2.1.4. 代码演示](#23214-代码演示)
            - [2.3.2.2. 相关方法详解](#2322-相关方法详解)
                - [2.3.2.2.1. Thread.sleep()方法、Object.wait（）方法的区别](#23221-threadsleep方法objectwait方法的区别)
                - [2.3.2.2.2. yield()方法，线程让步](#23222-yield方法线程让步)
                - [2.3.2.2.3. Join()方法](#23223-join方法)
                - [2.3.2.2.4. interrupt()与stop()，中断线程](#23224-interrupt与stop中断线程)
        - [2.3.3. 守护线程](#233-守护线程)
        - [2.3.4. 线程优先级](#234-线程优先级)
    - [2.4. 线程传参](#24-线程传参)
        - [2.4.1. 构造方法](#241-构造方法)
        - [2.4.2. 变量和方法](#242-变量和方法)
        - [2.4.3. 回调函数](#243-回调函数)
    - [2.5. 如何实现处理多线程的返回值](#25-如何实现处理多线程的返回值)
...
* **<font color = "lime">阻塞状态（BLOCKED）</font>**：阻塞状态是指线程因为某些原因放弃CPU，暂时停止运行。当线程处于阻塞状态时，Java虚拟机不会给线程分配CPU。直到线程重新进入就绪状态（获取监视器锁），它才有机会转到运行状态。可分为以下3种：  
...
##### 2.3.2.1.2. 线程阻塞BLOCKED和等待WAITING的区别  
<!-- 
...
#### 2.3.2.2. 相关方法详解
##### 2.3.2.2.1. Thread.sleep()方法、Object.wait（）方法的区别  
...
##### 2.3.2.2.4. interrupt()与stop()，中断线程  
...
## 2.5. 如何实现处理多线程的返回值  
<!-- 
https://mp.weixin.qq.com/s/av9BwkWJKgRLnTjFqqo6BA
-->
