...
![image](http://182.92.69.8:8081/img/ES/es-89.png)  

&emsp; 多个单词，可以用逗号或者空格隔开，例如chenqionghe,活动  
![image](http://182.92.69.8:8081/img/ES/es-90.png)  

&emsp; 可以指定字段:空格来查询，例如page: 18、content:"sport"  
![image](http://182.92.69.8:8081/img/ES/es-91.png)  
...
![image](http://182.92.69.8:8081/img/ES/es-92.png)  

&emsp; 搜索hi*er
![image](http://182.92.69.8:8081/img/ES/es-93.png)  

&emsp; 搜索*er
![image](http://182.92.69.8:8081/img/ES/es-94.png)  


### 1.2.3. 模糊查询
&emsp; ~：在一个单词后面加上~启用模糊搜索，可以搜到一些拼写错误的单词  
&emsp; 例如first~能匹配到错误的单词frist  
![image](http://182.92.69.8:8081/img/ES/es-95.png)  
...
![image](http://182.92.69.8:8081/img/ES/es-96.png)  
...
![image](http://182.92.69.8:8081/img/ES/es-97.png)  

&emsp; 搜索第2到第8页，不包含两端点page: {2 TO 8}  
![image](http://182.92.69.8:8081/img/ES/es-98.png)  

&emsp; 搜索第2到第8页，包含起始不包含末端page: [2 TO 8}  
![image](http://182.92.69.8:8081/img/ES/es-99.png)  

### 1.2.6. 优先级查询
&emsp; 如果单词的匹配度很高，一个文档中或者一个字段中可以匹配多次，那么可以提升该词的相关度。使用符号^提高相关度。
![image](http://182.92.69.8:8081/img/ES/es-100.png)  
![image](http://182.92.69.8:8081/img/ES/es-101.png)  
...
![image](http://182.92.69.8:8081/img/ES/es-102.png)  

&emsp; muscle NOT easy，muscle存在easy不存在  
![image](http://182.92.69.8:8081/img/ES/es-103.png)  

&emsp; muscle OR easy，muscle或easy存在  
![image](http://182.92.69.8:8081/img/ES/es-104.png)  

&emsp; 例如+life -lies：必须包含life，不包含lies  
![image](http://182.92.69.8:8081/img/ES/es-105.png)  

### 1.2.8. 括号分组
&emsp; 可以使用小括号对子句进行分组，构造更复杂的查询逻辑  
&emsp; chenqionghe OR (生命 AND 运动)  
![image](http://182.92.69.8:8081/img/ES/es-106.png)  

&emsp; 同时，也可以在字段中使用小括号分组，例如content:(+chenqionghe +"muscle")  
![image](http://182.92.69.8:8081/img/ES/es-107.png)  
...
![image](http://182.92.69.8:8081/img/ES/es-52.png)  
* 日志搜索检索  
&emsp; 如图所示：   
![image](http://182.92.69.8:8081/img/ES/es-53.png)  

* 日志索引选定  
&emsp; 点击下拉选项，可弹出全部索引列表  
![image](http://182.92.69.8:8081/img/ES/es-54.png)  

* 查询时间范围选定   
&emsp; 点击箭头处可打开日期选取界面，下方红框为设置自动刷新获取日志的时间间隔  
![image](http://182.92.69.8:8081/img/ES/es-55.png)  

* 日志内容搜索  
&emsp; 在箭头指向处可以搜索指定文本，搜索后在日志文本区匹配文本会高亮显示  
![image](http://182.92.69.8:8081/img/ES/es-56.png)  
![image](http://182.92.69.8:8081/img/ES/es-57.png)  
&emsp; 如果搜索字段为已切割字段，则可以键入切割字段名称，搜索框下方会弹出提示框，类似于Key:Value的使用：  
![image](http://182.92.69.8:8081/img/ES/es-58.png)  

* 日志已切割字段的使用  
&emsp; 鼠标移动到字段后方时，会出现添加按钮，点击后，右侧日志文本区会发生变化  
![image](http://182.92.69.8:8081/img/ES/es-59.png)  
&emsp; 日志会以选定字段展示，如果想恢复原状则可以在选定字段区域点击移除按钮  
![image](http://182.92.69.8:8081/img/ES/es-60.png)  
&emsp; 也可以将鼠标移动到字段名称上方，会出现是否继续选取该字段以及调整字段顺序的选项  
![image](http://182.92.69.8:8081/img/ES/es-61.png)  
* 日志正文查看  
&emsp; 默认切割字段内容和日志原文一同显示在页面中，如果需要查看详情可点击红框内箭头  
![image](http://182.92.69.8:8081/img/ES/es-62.png)  
![image](http://182.92.69.8:8081/img/ES/es-63.png)  
* 仪表板的使用  
&emsp; 选取菜单栏中仪表板  
![image](http://182.92.69.8:8081/img/ES/es-64.png)  
&emsp; 会出现已配置好的仪表板，点击即可进入该仪表板界面，使用方式与日志检索界面相同  
![image](http://182.92.69.8:8081/img/ES/es-65.png)  
