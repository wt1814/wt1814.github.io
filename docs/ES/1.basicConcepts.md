...
https://mp.weixin.qq.com/s/FnokIiFNUT1xG7iumLFF0Q

ElasticSearch 最全详细使用教程 
https://mp.weixin.qq.com/s/gi9Dxt23chmEgDK9ZWfHLw

下面
https://mp.weixin.qq.com/s/TiKDf8b0T5zH5hHol1IzMw


ElasticSearch 第三弹，核心概念介绍 
https://mp.weixin.qq.com/s/heSNVTPHaCTTjek0RqkSqA
...
江南一点雨
https://mp.weixin.qq.com/s/FzX8BvtN7m4BvE6QgAEX7g
-->
...
FST 有两个优点： 1、空间占用小。通过对词典中单词前缀和后缀的重复利用， 压缩了存储空间； 2、查询速度快。O(len(str))的查询时间复杂度。  
