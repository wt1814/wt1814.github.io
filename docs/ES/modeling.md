...
- [1. ES建模](#1-es建模)
    ...
    - [1.3. Mapping 如何设计？](#13-mapping-如何设计)
        ...
        - [1.3.2. 设计 Mapping 的注意事项](#132-设计-mapping-的注意事项)
        - [1.3.3. Mapping字段的设置流程](#133-mapping字段的设置流程)
        - [1.3.4. Mapping 建议结合模板定义](#134-mapping-建议结合模板定义)
        - [1.3.5. 包含Mapping的template设计万能模板](#135-包含mapping的template设计万能模板)
    - [1.4. 分词的选型](#14-分词的选型)
...
### 1.3.5. 包含Mapping的template设计万能模板
