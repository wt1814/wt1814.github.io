...
- [1. ES建模](#1-es建模)
    ...
    - [1.2. 文档document设计](#12-文档document设计)
    - [1.3. Mapping如何设计？](#13-mapping如何设计)
        - [1.3.1. Mapping字段的设置流程](#131-mapping字段的设置流程)
        - [1.3.2. Mapping建议结合模板定义](#132-mapping建议结合模板定义)
            - [1.3.2.1. 索引模版介绍](#1321-索引模版介绍)
            - [1.3.2.2. 包含Mapping的template设计万能模板](#1322-包含mapping的template设计万能模板)
...
#### 1.3.2.2. 包含Mapping的template设计万能模板
