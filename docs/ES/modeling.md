...
- [1. ES建模](#1-es建模)
    ...
    - [1.2. Mapping如何设计？](#12-mapping如何设计)
        - [1.2.1. Mapping字段的设置流程](#121-mapping字段的设置流程)
        - [1.2.2. Mapping建议结合模板定义](#122-mapping建议结合模板定义)
            - [1.2.2.1. 索引模版介绍](#1221-索引模版介绍)
            - [1.2.2.2. 包含Mapping的template设计万能模板](#1222-包含mapping的template设计万能模板)
        - [1.2.3. 设计Mapping的注意事项](#123-设计mapping的注意事项)
    - [1.3. 分词的选型](#13-分词的选型)
        - [1.3.1. 坑 1：分词选型](#131-坑-1分词选型)
        - [1.3.2. 坑 2：ik 要装集群的所有机器吗？](#132-坑-2ik-要装集群的所有机器吗)
        - [1.3.3. 坑 3：ik匹配不到怎么办？](#133-坑-3ik匹配不到怎么办)
    - [1.4. 文档document设计](#14-文档document设计)
    - [1.5. 多表关联如何设计？](#15-多表关联如何设计)
        - [1.5.1. 为什么会有多表关联](#151-为什么会有多表关联)
        - [1.5.2. 多表关联如何实现](#152-多表关联如何实现)
...
#### 1.2.2.2. 包含Mapping的template设计万能模板
