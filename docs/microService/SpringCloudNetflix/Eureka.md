...
- [1. Spring Cloud Eureka](#1-spring-cloud-eureka)
    ...
    - [1.2. Netflix Eureka](#12-netflix-eureka)
        ...
        - [1.3.2. 服务治理机制](#132-服务治理机制)
            - [1.3.2.1. 服务提供者](#1321-服务提供者)
                - [1.3.2.1.1. 服务同步](#13211-服务同步)
                - [1.3.2.1.2. 服务续约](#13212-服务续约)
            - [1.3.2.2. 服务消费者](#1322-服务消费者)
                - [1.3.2.2.1. 荻取服务](#13221-荻取服务)
                - [1.3.2.2.2. 服务调用](#13222-服务调用)
                - [1.3.2.2.3. 服务下线](#13223-服务下线)
            - [1.3.2.3. 服务注册中心](#1323-服务注册中心)
                - [1.3.2.3.1. 失效剔除](#13231-失效剔除)
                - [1.3.2.3.2. 自我保护](#13232-自我保护)
                    - [1.3.2.3.2.1. 自我保护实现逻辑](#132321-自我保护实现逻辑)

<!-- /TOC -->

&emsp; **<font color = "red">总结：</font>**  
&emsp; 服务治理框架和产品都围绕着服务注册与服务发现机制来完成对微服务应用实例的自动化管理。  

&emsp; Spring Cloud Eureka, 使用Netflix Eureka来实现服务注册与发现，它既包含了服务端组件，也包含了客户端组件。  
