...
-->
![image](http://182.92.69.8:8081/img/microService/SpringCloudNetflix/cloud-43.png)  
![image](http://182.92.69.8:8081/img/microService/SpringCloudNetflix/cloud-44.png)  
![image](http://182.92.69.8:8081/img/microService/SpringCloudNetflix/cloud-45.png)  


## 1.1. 全链路监控功能  
![image](http://182.92.69.8:8081/img/microService/SpringCloudNetflix/cloud-42.png)  
...
![image](http://182.92.69.8:8081/img/microService/SpringCloudNetflix/cloud-21.png)  
...
![image](http://182.92.69.8:8081/img/microService/SpringCloudNetflix/cloud-22.png)  
...
![image](http://182.92.69.8:8081/img/microService/SpringCloudNetflix/cloud-13.png)  
...
&emsp; 如果一个服务的调用关系如下：  
![image](http://182.92.69.8:8081/img/microService/SpringCloudNetflix/cloud-14.png)  
&emsp; 那么此时将Span和Trace在一个系统中使用Zipkin注解的过程图形化：  
![image](http://182.92.69.8:8081/img/microService/SpringCloudNetflix/cloud-15.png)  
...
![image](http://182.92.69.8:8081/img/microService/SpringCloudNetflix/cloud-16.png)  

**1. spans在zipkin界面的信息解读**  
&emsp; 在Zipkin中展示了上图的跟踪信息，红框里是对上图调用span的跟踪。
![image](http://182.92.69.8:8081/img/microService/SpringCloudNetflix/cloud-17.png)  
&emsp; 但是当点击这个trace时，只看到4个span。
![image](http://182.92.69.8:8081/img/microService/SpringCloudNetflix/cloud-18.png)  
...
![image](http://182.92.69.8:8081/img/microService/SpringCloudNetflix/cloud-19.png)  
&emsp; 点击红色的span，可以看到详细的失败信息：  
![image](http://182.92.69.8:8081/img/microService/SpringCloudNetflix/cloud-20.png)  
...
![image](http://182.92.69.8:8081/img/microService/SpringCloudNetflix/cloud-32.png)  
