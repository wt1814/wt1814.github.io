...
## 1.2. 请求过滤  
![image](http://182.92.69.8:8081/img/microService/SpringCloudNetflix/cloud-23.png)  
...
&emsp; 而对于后端应用来说，它们其实只需要知道请求属于谁，而不需要知道为什么，所以Gateway可以友善的帮助后端应用完成鉴权这个行为，并将用户的唯一标识透传到后端，而不需要、甚至不应该将身份信息也传递给后端，防止某些应用利用这些敏感信息做错误的事情。  
...
![image](http://182.92.69.8:8081/img/microService/SpringCloudNetflix/cloud-24.png)  
...
![image](http://182.92.69.8:8081/img/microService/SpringCloudNetflix/cloud-25.png)  
