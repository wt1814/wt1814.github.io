...
![image](http://182.92.69.8:8081/img/microService/mq/kafka/kafka-36.png)  
&emsp; 可以看到监听器消费成功。
![image](http://182.92.69.8:8081/img/microService/mq/kafka/kafka-37.png)  
...
```
&emsp; 执行看一下效果，  
![image](http://182.92.69.8:8081/img/microService/mq/kafka/kafka-38.png)  
...
![image](http://182.92.69.8:8081/img/microService/mq/kafka/kafka-39.png)  
...
![image](http://182.92.69.8:8081/img/microService/mq/kafka/kafka-40.png)  
&emsp; 11:42分监听器启动开始工作，消费消息。  
![image](http://182.92.69.8:8081/img/microService/mq/kafka/kafka-41.png)  
