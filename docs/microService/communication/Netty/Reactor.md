...
![image](http://www.wt1814.com/static/view/images/microService/netty/netty-36.png)  
...
-->
&emsp; `Reactor，是网络编程中基于IO多路复用的一种设计模式，是event-driven architecture的一种实现方式，处理多个客户端并发的向服务端请求服务的场景。`每种服务在服务端可能由多个方法组成。reactor会解耦并发请求的服务并分发给对应的事件处理器来处理。目前，许多流行的开源框架都用到了reactor模式，如：netty、node.js等，包括java的nio。  

        维基百科上的定义：“反应堆设计模式是一种事件处理模式，用于处理由一个或多个输入同时发送的服务请求。然后，服务处理程序将传入的请求多路分解，并同步地将其分发到关联的请求处理程序”。

&emsp; 总体图示如下：  
![image](http://www.wt1814.com/static/view/images/microService/netty/netty-37.png)  
![image](http://www.wt1814.com/static/view/images/microService/netty/netty-105.png)  
<center>Reactor网络模型</center>  

![image](http://www.wt1814.com/static/view/images/microService/netty/netty-106.png)  
...
![image](http://www.wt1814.com/static/view/images/microService/netty/netty-107.png)  
...
![image](http://www.wt1814.com/static/view/images/microService/netty/netty-108.png)  
...
![image](http://www.wt1814.com/static/view/images/microService/netty/netty-82.png)  
-->
...
-->
![image](http://www.wt1814.com/static/view/images/microService/netty/netty-90.png)  
...
![image](http://www.wt1814.com/static/view/images/microService/netty/netty-120.png)  
...
![image](http://www.wt1814.com/static/view/images/microService/netty/netty-10.png)  
![image](http://www.wt1814.com/static/view/images/microService/netty/netty-83.png)  
...
![image](http://www.wt1814.com/static/view/images/microService/netty/netty-121.png)  
&emsp; 相对于第一种单线程的模式来说，在处理业务逻辑，也就是获取到IO的读写事件之后，交由线程池来处理，这样可以减小主reactor的性能开销，从而更专注的做事件分发工作了，从而提升整个应用的吞吐。  
...
![image](http://www.wt1814.com/static/view/images/microService/netty/netty-11.png)  
![image](http://www.wt1814.com/static/view/images/microService/netty/netty-84.png)  
...
![image](http://www.wt1814.com/static/view/images/microService/netty/netty-13.png)  
...
![image](http://www.wt1814.com/static/view/images/microService/netty/netty-122.png)  
&emsp; 第三种模型比起第二种模型，是将Reactor分成两部分：  
...
![image](http://www.wt1814.com/static/view/images/microService/netty/netty-12.png)  
![image](http://www.wt1814.com/static/view/images/microService/netty/netty-85.png)  
...
![image](http://www.wt1814.com/static/view/images/microService/netty/netty-14.png)  
...
## 1.4. 主流的中间件所采用的网络模型  
![image](http://www.wt1814.com/static/view/images/microService/netty/netty-133.png)  
...
![image](http://www.wt1814.com/static/view/images/microService/netty/netty-86.png)  
