...
- [1. 分布式事务小结](#1-分布式事务小结)
    - [1.1. 多种分布式事务比较](#11-多种分布式事务比较)
    - [1.2. 分布式事务的选型](#12-分布式事务的选型)
        - [1.2.1. 选型取舍关键](#121-选型取舍关键)
        - [1.2.2. 具体选型](#122-具体选型)
        - [1.2.3. 结论：并非一种事务形态就能打遍天下](#123-结论并非一种事务形态就能打遍天下)
    - [1.3. 实际使用](#13-实际使用)
