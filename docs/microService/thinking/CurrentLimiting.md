...
3. 限流算法：  
    ...
    * 漏桶算法，实现`流量整形和流量控制`。漏洞底部的设计大小固定，水流速度固定。漏桶算法的缺陷也很明显，当短时间内有大量的突发请求时，即便此时服务器没有任何负载，每个请求也都得在队列中等待一段时间才能被响应。  
    * 令牌桶算法，
...
<!-- 
后端服务不得不了解之限流
https://mp.weixin.qq.com/s/tlaL0ByrWVQ0qiDssSPWnQ
...
Redis + Lua 实现系统限流
https://blog.csdn.net/qq_37936542/article/details/105648277
