...
![image](http://www.wt1814.com/static/view/images/microService/Dubbo/dubbo-56.png)  
...
#### 1.3.2.2. FailbackClusterInvoker
...
#### 1.3.2.4. FailsafeClusterInvoker
...
&emsp; 关于 ForkingClusterInvoker 就先分析到这，接下来分析最后一个 Cluster Invoker。  
