...
- [1. Zookeeper](#1-zookeeper)
    ...
    - [1.4. 脑裂](#14-脑裂)
    - [1.5. Zookeeper的CP模型](#15-zookeeper的cp模型)
    - [1.6. Zookeeper应用场景](#16-zookeeper应用场景)
        - [1.6.1. 集群管理，HA高可用性](#161-集群管理ha高可用性)
        - [1.6.2. 元数据/配置信息管理](#162-元数据配置信息管理)
        - [1.6.3. 分布式锁](#163-分布式锁)
        - [1.6.4. 分布式协调](#164-分布式协调)
        - [1.6.5. 统一命名服务](#165-统一命名服务)
        - [1.6.6. 队列管理](#166-队列管理)
