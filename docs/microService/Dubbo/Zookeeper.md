...
- [1. Zookeeper](#1-zookeeper)
    - [1.1. Zookeeper的CP模型](#11-zookeeper的cp模型)
    - [1.2. Zookeeper是什么](#12-zookeeper是什么)
    - [1.3. ZooKeeper分层命名空间](#13-zookeeper分层命名空间)
    - [1.4. Zookeeper的运行原理](#14-zookeeper的运行原理)
        - [1.4.1. ※※※Watcher机制](#141-※※※watcher机制)
        - [1.4.2. ※※※ZAB协议](#142-※※※zab协议)
            - [1.4.2.1. 选举流程，恢复模式](#1421-选举流程恢复模式)
            - [1.4.2.2. 数据同步，广播模式](#1422-数据同步广播模式)
