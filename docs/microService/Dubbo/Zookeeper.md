...
- [4. Zookeeper应用](#4-zookeeper应用)
    - [4.1. 应用场景：](#41-应用场景)
        - [4.1.1. 分布式协调](#411-分布式协调)
        - [4.1.2. 统一命名服务](#412-统一命名服务)
        - [4.1.3. 元数据/配置信息管理](#413-元数据配置信息管理)
        - [4.1.4. 集群管理，HA高可用性](#414-集群管理ha高可用性)
        - [4.1.5. 分布式锁](#415-分布式锁)
        - [4.1.6. 队列管理](#416-队列管理)
    - [4.2. Zookeeper的API](#42-zookeeper的api)
        - [4.2.1. 原生API](#421-原生api)
        - [4.2.2. ZkClient](#422-zkclient)
        - [4.2.3. Curator](#423-curator)
    - [4.3. Zookeeper监控](#43-zookeeper监控)
