...
- [1. Dubbo](#1-dubbo)
    ...
    - [1.2. Dubbo需要Web容器吗？内置了哪几种服务容器？](#12-dubbo需要web容器吗内置了哪几种服务容器)
    - [1.3. Dubbo有哪些注册中心？](#13-dubbo有哪些注册中心)
    - [1.4. Dubbo支持哪些序列化方式？](#14-dubbo支持哪些序列化方式)
    - [1.5. 通信协议](#15-通信协议)
    - [1.6. 服务提供者能实现失效踢出是什么原理？](#16-服务提供者能实现失效踢出是什么原理)
    - [1.7. Dubbo服务之间的调用是阻塞的吗？](#17-dubbo服务之间的调用是阻塞的吗)
    - [1.8. ※※※负载均衡](#18-※※※负载均衡)
    - [1.9. ※※※集群容错策略](#19-※※※集群容错策略)
    - [1.10. 服务降级](#110-服务降级)
    - [1.11. Dubbo和Spring Cloud](#111-dubbo和spring-cloud)
    - [1.12. Dubbo生态](#112-dubbo生态)
        - [1.12.1. Dubbo与分布式事务](#1121-dubbo与分布式事务)
...
## 1.6. 服务提供者能实现失效踢出是什么原理？  
&emsp; 服务失效踢出基于zookeeper的临时节点原理。  

## 1.7. Dubbo服务之间的调用是阻塞的吗？  
...
* 两个框架在开始目标就不一致：<font color = "red">Dubbo 定位服务治理；Spirng Cloud 是一个生态。</font>  
