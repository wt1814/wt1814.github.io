...
- [1. Redis配置文件](#1-redis配置文件)
    - [1.1. redis.conf配置项说明](#11-redisconf配置项说明)
    - [1.2. Redis配置文件翻译](#12-redis配置文件翻译)
    - [1.3. Redis配置实战](#13-redis配置实战)

<!-- /TOC -->

# 1. Redis配置文件  
&emsp; 在Redis的使用中，除了掌握Redis的API外，了解redis.conf就是其次了。  
