...
&emsp; **<font color = "red">根据执行分片的位置，可以分为三种分片方式：</font>** 客户端分片、代理分片、服务器分片：官方Redis Cluster。  

&emsp; **<font color = "clime">Redis集群服务端：</font>**  
* 数据分布
    * Redis数据分区
    * 集群限制
...
&emsp; **<font color = "clime">Redis集群客户端：</font>**  
