...
- [1. Nginx使用场景](#1-nginx使用场景)
    ...
    - [1.4. 静态服务器](#14-静态服务器)
    - [1.5. Nginx搭建图⽚服务器](#15-nginx搭建图⽚服务器)
    - [1.6. 动静分离](#16-动静分离)
    - [1.7. 跨域解决](#17-跨域解决)
    - [1.8. 地址重定向，Rewrite](#18-地址重定向rewrite)
    - [1.9. HTTPS反向代理配置](#19-https反向代理配置)
    - [1.10. 其他功能](#110-其他功能)
        - [1.10.1. 缓存](#1101-缓存)
        - [1.10.2. 限流](#1102-限流)
        - [1.10.3. 黑白名单](#1103-黑白名单)
        - [1.10.4. 防盗链](#1104-防盗链)
        - [1.10.5. 流量复制](#1105-流量复制)
        - [1.10.6. 正向代理](#1106-正向代理)
