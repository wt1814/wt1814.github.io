...
- [1. 基于配置文件的Nginx处理请求流程](#1-基于配置文件的nginx处理请求流程)
    - [1.1. IP和域名部分的处理](#11-ip和域名部分的处理)
    - [1.2. Location详解](#12-location详解)
- [2. Nginx使用场景](#2-nginx使用场景)
    - [2.1. 反向代理](#21-反向代理)
        - [2.1.1. 代理服务器简介](#211-代理服务器简介)
            - [2.1.1.1. 正向代理](#2111-正向代理)
            - [2.1.1.2. 反向代理](#2112-反向代理)
            - [2.1.1.3. 正向代理和反向代理对比](#2113-正向代理和反向代理对比)
        - [2.1.2. ※※※Nginx负载均衡](#212-※※※nginx负载均衡)
    - [2.2. 虚拟主机](#22-虚拟主机)
    - [2.3. 多个webapp的配置](#23-多个webapp的配置)
    - [2.4. 静态资源WEB服务](#24-静态资源web服务)
        - [2.4.1. Nginx搭建图⽚服务器](#241-nginx搭建图⽚服务器)
    - [2.5. 动静分离](#25-动静分离)
    - [2.6. 跨域解决](#26-跨域解决)
    - [2.7. 地址重定向，Rewrite](#27-地址重定向rewrite)
    - [2.8. HTTPS反向代理配置](#28-https反向代理配置)
    - [2.9. 其他功能](#29-其他功能)
        - [2.9.1. 缓存](#291-缓存)
        - [2.9.2. 限流](#292-限流)
        - [2.9.3. 黑白名单](#293-黑白名单)
        ...
        - [2.9.5. 流量复制](#295-流量复制)
        - [2.9.6. 正向代理](#296-正向代理)
- [3. Nginx配置参数中文说明](#3-nginx配置参数中文说明)
