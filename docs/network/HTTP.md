...
- [1. HTTP](#1-http)
    ...
    - [1.2. HTTP介绍](#12-http介绍)
        - [1.2.1. HTTP消息结构](#121-http消息结构)
            - [1.2.1.1. URI](#1211-uri)
                - [1.2.1.1.1. URL](#12111-url)
                - [1.2.1.1.2. 请求地址最后面的“/”加和不加到底有什么区别？](#12112-请求地址最后面的加和不加到底有什么区别)
            - [1.2.1.2. 请求和响应报文](#1212-请求和响应报文)
                - [1.2.1.2.1. 客户端请求消息](#12121-客户端请求消息)
                - [1.2.1.2.2. 服务器响应消息](#12122-服务器响应消息)
            - [1.2.1.3. HTTP具体头信息](#1213-http具体头信息)
            - [1.2.1.4. HTTP实体类型](#1214-http实体类型)
        - [1.2.2. HTTP方法](#122-http方法)
            - [1.2.2.1. ★★★HTTP中GET与POST的区别](#1221-★★★http中get与post的区别)
        - [1.2.3. HTTP状态码](#123-http状态码)
    - [1.3. ★★★一次完整的HTTP请求处理流程](#13-★★★一次完整的http请求处理流程)
    - [1.4. Http与TCP](#14-http与tcp)
...
##### 1.2.1.1.2. 请求地址最后面的“/”加和不加到底有什么区别？  
&emsp; 下图是一个完整的URI：  
