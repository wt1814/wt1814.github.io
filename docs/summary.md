...
<!-- TOC -->autoauto- [1. 总结](#1-总结)auto    - [1.1. Java](#11-java)auto        - [1.1.1. Java基础](#111-java基础)auto        - [1.1.2. Java基础数据类型](#112-java基础数据类型)auto            - [1.1.2.1. String](#1121-string)auto            - [1.1.2.2. Java基本数据类型](#1122-java基本数据类型)auto        - [1.1.3. Java集合框架](#113-java集合框架)auto            - [1.1.3.1. Java集合框架](#1131-java集合框架)auto            - [1.1.3.2. HashMap](#1132-hashmap)auto                - [1.1.3.2.1. HashMap源码](#11321-hashmap源码)auto                - [1.1.3.2.2. HashMap安全](#11322-hashmap安全)auto            - [1.1.3.3. Collection](#1133-collection)auto        - [1.1.4. JDK1.8](#114-jdk18)auto            - [1.1.4.1. 接口的默认方法与静态方法](#1141-接口的默认方法与静态方法)auto            - [1.1.4.2. Lambda表达式](#1142-lambda表达式)auto            - [1.1.4.3. Stream](#1143-stream)auto            - [1.1.4.4. Optional](#1144-optional)auto            - [1.1.4.5. DateTime](#1145-datetime)auto        - [1.1.5. Java异常](#115-java异常)auto        - [1.1.6. Java范型](#116-java范型)auto        - [1.1.7. IO](#117-io)auto        - [1.1.8. SPI与线程上下文类加载器](#118-spi与线程上下文类加载器)auto        - [1.1.9. 反射](#119-反射)auto        - [1.1.10. 自定义注解](#1110-自定义注解)auto    - [1.2. 设计模式](#12-设计模式)auto        - [1.2.1. 七大设计原则](#121-七大设计原则)auto        - [1.2.2. 复用规则（继承和组合）详解](#122-复用规则继承和组合详解)auto        - [1.2.3. 设计模式详解](#123-设计模式详解)auto            - [1.2.3.1. 5种创建型设计模式](#1231-5种创建型设计模式)auto            - [1.2.3.2. 7种结构型设计模式（横向4 + 纵向2 + 1）](#1232-7种结构型设计模式横向4--纵向2--1)auto            - [1.2.3.3. 两种动态代理](#1233-两种动态代理)auto            - [1.2.3.4. 11种行为型设计模式](#1234-11种行为型设计模式)auto            - [1.2.3.5. 设计模式大讨论](#1235-设计模式大讨论)auto                - [1.2.3.5.1. 结构型模式的讨论](#12351-结构型模式的讨论)auto                - [1.2.3.5.2. 行为型模式的讨论](#12352-行为型模式的讨论)auto            - [1.2.3.6. 设计模式混编](#1236-设计模式混编)auto            - [1.2.3.7. 常使用的设计模式](#1237-常使用的设计模式)auto    - [1.3. JVM](#13-jvm)auto        - [1.3.1. JDK、JRE、JVM](#131-jdkjrejvm)auto        - [1.3.2. 编译成Class字节码文件](#132-编译成class字节码文件)auto        - [1.3.3. 类加载](#133-类加载)auto            - [1.3.3.1. JVM类的加载](#1331-jvm类的加载)auto            - [1.3.3.2. ~~JVM类加载器~~](#1332-jvm类加载器)auto        - [1.3.4. 运行时数据区/内存结构](#134-运行时数据区内存结构)auto            - [1.3.4.1. JVM内存结构](#1341-jvm内存结构)auto                - [1.3.4.1.1. JVM内存结构](#13411-jvm内存结构)auto                - [1.3.4.1.2. 类存储内存小结](#13412-类存储内存小结)auto                    - [1.3.4.1.2.1. 变量](#134121-变量)auto                    - [1.3.4.1.2.2. 静态方法和实例方法](#134122-静态方法和实例方法)auto                - [1.3.4.1.3. 常量池详解](#13413-常量池详解)auto            - [1.3.4.2. 内存(堆栈)中的对象](#1342-内存堆栈中的对象)auto                - [1.3.4.2.1. 创建对象](#13421-创建对象)auto                - [1.3.4.2.2. 对象生命周期](#13422-对象生命周期)auto                - [1.3.4.2.3. 对象大小](#13423-对象大小)auto            - [1.3.4.3. 内存泄露](#1343-内存泄露)auto        - [1.3.5. JVM执行](#135-jvm执行)auto        - [1.3.6. GC](#136-gc)auto            - [1.3.6.1. GC-回收位置/安全点](#1361-gc-回收位置安全点)auto            - [1.3.6.2. 回收算法与分代回收](#1362-回收算法与分代回收)auto            - [1.3.6.3. GC-回收对象](#1363-gc-回收对象)auto                - [1.3.6.3.1. 堆中对象的存活](#13631-堆中对象的存活)auto                - [1.3.6.3.2. 方法区(类和常量)回收/类的卸载阶段](#13632-方法区类和常量回收类的卸载阶段)auto                - [1.3.6.3.3. null与GC](#13633-null与gc)auto            - [1.3.6.4. GC-垃圾回收器](#1364-gc-垃圾回收器)auto                - [1.3.6.4.1. 垃圾回收器](#13641-垃圾回收器)auto                - [1.3.6.4.2. CMS回收器](#13642-cms回收器)auto                - [1.3.6.4.3. G1回收器](#13643-g1回收器)auto                - [1.3.6.4.4. 三色标记，并发标记阶段](#13644-三色标记并发标记阶段)auto        - [1.3.7. JVM调优](#137-jvm调优)auto            - [1.3.7.1. JVM调优-基础](#1371-jvm调优-基础)auto            - [1.3.7.2. JVM调优](#1372-jvm调优)auto            - [1.3.7.3. JVM问题排查](#1373-jvm问题排查)auto            - [1.3.7.4. Arthas工具](#1374-arthas工具)auto    - [1.4. 多线程和并发](#14-多线程和并发)auto        - [1.4.1. 线程Thread](#141-线程thread)auto            - [1.4.1.1. 线程状态详解](#1411-线程状态详解)auto        - [1.4.2. 线程池-多线程](#142-线程池-多线程)auto            - [1.4.2.1. 线程池框架](#1421-线程池框架)auto            - [1.4.2.2. ThreadPoolExecutor详解](#1422-threadpoolexecutor详解)auto            - [1.4.2.3. 线程池的正确使用](#1423-线程池的正确使用)auto            - [1.4.2.4. ForkJoinPool详解](#1424-forkjoinpool详解)auto            - [1.4.2.5. ~~CompletionService~~](#1425-completionservice)auto            - [1.4.2.6. Future相关](#1426-future相关)auto            - [1.4.2.7. ~~CompletableFuture~~](#1427-completablefuture)auto        - [1.4.3. 并发编程](#143-并发编程)auto            - [1.4.3.1. 并发编程原理](#1431-并发编程原理)auto                - [1.4.3.1.1. ~~CPU多核缓存架构及JMM~~](#14311-cpu多核缓存架构及jmm)auto                - [1.4.3.1.2. 并发安全问题产生原因](#14312-并发安全问题产生原因)auto                - [1.4.3.1.3. 硬件解决并发安全](#14313-硬件解决并发安全)auto                - [1.4.3.1.4. Java解决并发安全](#14314-java解决并发安全)auto            - [1.4.3.2. 线程安全解决](#1432-线程安全解决)auto                - [1.4.3.2.1. 线程安全解决方案](#14321-线程安全解决方案)auto                - [1.4.3.2.2. Synchronized](#14322-synchronized)auto                    - [1.4.3.2.2.1. Synchronized介绍](#143221-synchronized介绍)auto                    - [1.4.3.2.2.2. Synchronized使用](#143222-synchronized使用)auto                - [1.4.3.2.3. ~~Synchronized使用是否安全~~](#14323-synchronized使用是否安全)auto                    - [1.4.3.2.3.1. Synchronized底层原理](#143231-synchronized底层原理)auto                    - [1.4.3.2.3.2. Synchronized优化](#143232-synchronized优化)auto                - [1.4.3.2.4. Volatile](#14324-volatile)auto                - [1.4.3.2.5. ThreadLocal](#14325-threadlocal)auto                    - [1.4.3.2.5.1. ThreadLocal原理](#143251-threadlocal原理)auto                    - [1.4.3.2.5.2. ThreadLocal应用](#143252-threadlocal应用)auto            - [1.4.3.3. 线程通信(生产者消费者问题)](#1433-线程通信生产者消费者问题)auto            - [1.4.3.4. 线程活跃性](#1434-线程活跃性)auto        - [1.4.4. JUC](#144-juc)auto            - [1.4.4.1. CAS](#1441-cas)auto            - [1.4.4.2. AQS](#1442-aqs)auto                - [1.4.4.2.1. LockSupport类](#14421-locksupport类)auto            - [1.4.4.3. LOCK](#1443-lock)auto                - [1.4.4.3.1. ReentrantLock，重入锁](#14431-reentrantlock重入锁)auto                    - [1.4.4.3.1.1. 读写锁](#144311-读写锁)auto            - [1.4.4.4. Atomic](#1444-atomic)auto                - [1.4.4.4.1. AtomicStampedReference与AtomicMarkableReference](#14441-atomicstampedreference与atomicmarkablereference)auto                - [1.4.4.4.2. LongAdder](#14442-longadder)auto            - [1.4.4.5. Collections](#1445-collections)auto                - [1.4.4.5.1. CopyOnWriteArrayList](#14451-copyonwritearraylist)auto                - [1.4.4.5.2. ConcurrentHashMap](#14452-concurrenthashmap)auto                - [1.4.4.5.3. BlockingQueue](#14453-blockingqueue)auto            - [1.4.4.6. tools](#1446-tools)auto                - [1.4.4.6.1. CountDownLatch](#14461-countdownlatch)auto                - [1.4.4.6.2. CyclicBarrier](#14462-cyclicbarrier)auto                - [1.4.4.6.3. Semaphore](#14463-semaphore)auto    - [1.5. 数据库](#15-数据库)auto        - [1.5.1. SQL语句](#151-sql语句)auto            - [1.5.1.1. 基本查询语句](#1511-基本查询语句)auto            - [1.5.1.2. 连接查询](#1512-连接查询)auto            - [1.5.1.3. ~~高级查询~~](#1513-高级查询)auto        - [1.5.2. MySql优化](#152-mysql优化)auto            - [1.5.2.1. SQL分析](#1521-sql分析)auto                - [1.5.2.1.1. Expain](#15211-expain)auto            - [1.5.2.2. SQL优化](#1522-sql优化)auto            - [1.5.2.3. 索引优化](#1523-索引优化)auto            - [1.5.2.4. 碎片优化](#1524-碎片优化)auto        - [1.5.3. 数据库分布式](#153-数据库分布式)auto            - [1.5.3.1. 大数据量操作](#1531-大数据量操作)auto            - [1.5.3.2. MySql瓶颈](#1532-mysql瓶颈)auto            - [1.5.3.3. 数据库分布式](#1533-数据库分布式)auto            - [1.5.3.4. 主从复制](#1534-主从复制)auto                - [1.5.3.4.1. 主从复制原理](#15341-主从复制原理)auto                - [1.5.3.4.2. 主从复制实现](#15342-主从复制实现)auto                - [1.5.3.4.3. 主从复制问题](#15343-主从复制问题)auto                - [1.5.3.4.4. 高可用实现](#15344-高可用实现)auto                - [1.5.3.4.5. 读写分离实现](#15345-读写分离实现)auto            - [1.5.3.5. 分区](#1535-分区)auto            - [1.5.3.6. 分库分表](#1536-分库分表)auto                - [1.5.3.6.1. 分库分表](#15361-分库分表)auto                - [1.5.3.6.2. 分库分表查询](#15362-分库分表查询)auto                    - [1.5.3.6.2.1. 非partition key的查询 / 分库分表多维度查询](#153621-非partition-key的查询--分库分表多维度查询)auto                    - [1.5.3.6.2.2. 跨分片的分组group by以及聚合count等函数](#153622-跨分片的分组group-by以及聚合count等函数)auto                    - [1.5.3.6.2.3. 跨分片的排序分页](#153623-跨分片的排序分页)auto                    - [1.5.3.6.2.4. 跨节点Join的问题](#153624-跨节点join的问题)auto                    - [1.5.3.6.2.5. ~~**<font color = "blue">小结：分库分表分片键设计</font>**~~](#153625-font-color--blue小结分库分表分片键设计font)auto            - [1.5.3.7. 数据迁移](#1537-数据迁移)auto        - [1.5.4. MySql架构](#154-mysql架构)auto            - [1.5.4.1. MySql运行流程](#1541-mysql运行流程)auto            - [1.5.4.2. Server层之binLog日志](#1542-server层之binlog日志)auto            - [1.5.4.3. 存储引擎层](#1543-存储引擎层)auto            - [1.5.4.4. InnoDB体系结构](#1544-innodb体系结构)auto                - [1.5.4.4.1. InnoDB内存结构-性能](#15441-innodb内存结构-性能)auto                    - [1.5.4.4.1.1. BufferPool](#154411-bufferpool)auto                    - [1.5.4.4.1.2. 写缓冲ChangeBuffer](#154412-写缓冲changebuffer)auto                    - [1.5.4.4.1.3. AdaptiveHashIndex](#154413-adaptivehashindex)auto                - [1.5.4.4.2. InnoDB磁盘结构-可靠性](#15442-innodb磁盘结构-可靠性)auto                    - [1.5.4.4.2.1. undoLog](#154421-undolog)auto                    - [1.5.4.4.2.2. redoLog](#154422-redolog)auto                    - [1.5.4.4.2.3. DoubleWrite](#154423-doublewrite)auto                - [1.5.4.4.3. ~~两阶段提交和崩溃恢复~~](#15443-两阶段提交和崩溃恢复)auto                    - [1.5.4.4.3.1. BufferPool落盘表空间](#154431-bufferpool落盘表空间)auto        - [1.5.5. 索引事物锁](#155-索引事物锁)auto            - [1.5.5.1. 索引底层原理](#1551-索引底层原理)auto            - [1.5.5.2. ~~各种索引~~（还需要总结）](#1552-各种索引还需要总结)auto            - [1.5.5.3. MySql事务（还需要总结）](#1553-mysql事务还需要总结)auto            - [1.5.5.4. MVCC](#1554-mvcc)auto            - [1.5.5.5. MySql锁](#1555-mysql锁)auto            - [1.5.5.6. MySql死锁和锁表](#1556-mysql死锁和锁表)autoauto<!-- /TOC -->
...
2. HashMap成员方法：  
    1. `hash()函数/扰动函数：`  
    &emsp; hash函数会根据传递的`key值进行计算，获取hash值`。 1)首先计算key的hashCode值， 2)然后再对hashcode进行无符号右移操作， 3)最后再和hashCode进行异或 ^ 操作。（即让hashcode的高16位和低16位进行异或操作。）   
...
&emsp; `因为使用的是2次幂的扩展（指长度扩为原来2倍），所以元素的位置要么是在原位置，要么是在原位置再移动2次幂的位置。`因此，在扩充 HashMap 的时候，不需要像 JDK1.7 的实现那样重新计算 hash，只需要看看原来的 hash 值新增的那个 bit 是 1 还是 0 就好了，是 0 的话索引没变，是 1 的话索引变成“原索引 +oldCap。  
