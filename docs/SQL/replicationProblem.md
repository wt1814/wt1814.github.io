...
- [1. 复制的问题和解决方案](#1-复制的问题和解决方案)
    - [1.1. 复制延迟过大](#11-复制延迟过大)
    - [1.2. 《mysql深入浅出开发、优化与管理维护》](#12-mysql深入浅出开发优化与管理维护)
        - [1.2.1. 大对象blog,text传输](#121-大对象blogtext传输)
        - [1.2.2. ~~主从不一致后锁表~~](#122-主从不一致后锁表)
        - [1.2.3. 如何查看主从延迟？](#123-如何查看主从延迟)
        - [1.2.4. 跳过错误](#124-跳过错误)
        - [1.2.5. 如何提高复制性能？](#125-如何提高复制性能)
        - [1.2.6. 主从切换](#126-主从切换)
    - [1.3. 《高性能MySql》相关章节](#13-高性能mysql相关章节)
...
![image](http://182.92.69.8:8081/img/SQL/sql-98.png)  
...
![image](http://182.92.69.8:8081/img/SQL/sql-61.png)  
...
![image](http://182.92.69.8:8081/img/SQL/sql-62.png)  
...
![image](http://182.92.69.8:8081/img/SQL/sql-63.png)  
