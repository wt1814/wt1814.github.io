...
- [1. SQL优化](#1-sql优化)
    ...
    - [1.4. EXPLAIN、PROCEDURE ANALYSE(分析)](#14-explainprocedure-analyse分析)
        ...
        - [1.4.4. profiling](#144-profiling)
            - [1.4.4.1. 查看 profile 开启情况](#1441-查看-profile-开启情况)
            - [1.4.4.2. 启用 profile](#1442-启用-profile)
            - [1.4.4.3. 查看执行的 SQL 列表](#1443-查看执行的-sql-列表)
    ...
    - [1.6. 数据库表结构设计](#16-数据库表结构设计)
        ...
        - [1.6.3. 读写分离](#163-读写分离)
    - [1.7. 系统调优](#17-系统调优)
        - [1.7.1. 查看 MySQL 服务器运行的状态值](#171-查看-mysql-服务器运行的状态值)
