...
- [1. 分库分表带来的问题](#1-分库分表带来的问题)
    ...
    - [1.2. 分库分表带来的分布式困境与解决方案](#12-分库分表带来的分布式困境与解决方案)
        - [1.2.1. 分库数量](#121-分库数量)
        - [1.2.2. ID问题](#122-id问题)
        - [1.2.3. 基本的数据库增删改功能](#123-基本的数据库增删改功能)
        - [1.2.4. 查询功能](#124-查询功能)
            - [1.2.4.1. 分库分表多维度查询](#1241-分库分表多维度查询)
            - [1.2.4.2. 跨分片的排序order by、分组group by以及聚合count等函数问题](#1242-跨分片的排序order-by分组group-by以及聚合count等函数问题)
            - [1.2.4.3. 跨分片的排序分页](#1243-跨分片的排序分页)
            - [1.2.4.4. 跨节点Join的问题](#1244-跨节点join的问题)
            - [1.2.4.5. 非partition key的查询问题](#1245-非partition-key的查询问题)
        - [1.2.5. 跨分片事务](#125-跨分片事务)
        - [1.2.6. 数据迁移，容量规划，扩容等问题](#126-数据迁移容量规划扩容等问题)
...
#### 1.2.4.2. 跨分片的排序order by、分组group by以及聚合count等函数问题  
