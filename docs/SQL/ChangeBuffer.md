...
![image](http://182.92.69.8:8081/img/SQL/sql-101.png)  
...
![image](http://182.92.69.8:8081/img/SQL/sql-102.png)  
此时麻烦一点，如上图需要1-3：  
...
&emsp; 假如要修改页号为40的索引页，而这个页正好不在缓冲池内。  
![image](http://182.92.69.8:8081/img/SQL/sql-103.png)  
...
![image](http://182.92.69.8:8081/img/SQL/sql-104.png)  
&emsp; 此时的流程如序号1-3：  
...
## 1.4. 相关参数
&emsp; **有关写缓冲的参数：**  
![image](http://182.92.69.8:8081/img/SQL/sql-100.png)  
