...
![avatar](../../images/java/JVM/JVM-35.png)  
...
&emsp; jmap -heap PID  
![avatar](../../images/java/JVM/JVM-36.png)  
...
![avatar](../../images/java/JVM/JVM-37.png)  
##### 3.2. Jhat：虚拟机堆转储快照分析工具  
...
![avatar](../../images/java/JVM/JVM-38.png)  
2. 查看垃圾收集信息
&emsp; jstat -gc PID 1000 10  
![avatar](../../images/java/JVM/JVM-39.png)  
##### 5. Jinfo：java配置信息工具
...
![avatar](../../images/java/JVM/JVM-40.png)  
...
3. 查看曾经赋过值的一些参数  
jinfo -flags PID  
![avatar](../../images/java/JVM/JVM-41.png)  
