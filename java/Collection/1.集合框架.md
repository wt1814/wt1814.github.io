...
- [1. 集合类](#1-集合类)
    ...
    - [1.3. 集合使用：](#13-集合使用)
        - [1.3.1. ArrayList修改元素的炕-1](#131-arraylist修改元素的炕-1)
        - [1.3.2. Java集合不能存放基本数据类型，只存放对象的引用](#132-java集合不能存放基本数据类型只存放对象的引用)
...
### 1.3.2. Java集合不能存放基本数据类型，只存放对象的引用  
