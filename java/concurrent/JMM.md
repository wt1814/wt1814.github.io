...
- [1. JMM](#1-jmm)
    ...
    - [1.2. Java并发原因：重排序](#12-java并发原因重排序)
    ...
    - [1.3. 了解计算机硬件内存模型](#13-了解计算机硬件内存模型)
    - [1.4. Java内存模型的抽象](#14-java内存模型的抽象)
        - [1.4.1. JMM中内存划分](#141-jmm中内存划分)
        - [1.4.2. 内存间的交互操作](#142-内存间的交互操作)
        - [1.4.3. JMM中的happens-before原则](#143-jmm中的happens-before原则)
        - [1.4.4. 内存屏障-1](#144-内存屏障-1)
    - [1.5. java并发原语](#15-java并发原语)
