...
&emsp; &emsp; [安全点](/docs/java/JVM/safePoint.md)  
&emsp; [GC-回收器](/docs/java/JVM/GCReclaimer.md)  
&emsp; &emsp; [StopTheWord](/docs/java/JVM/stopTheWord.md)  
...
&emsp; &emsp; [ByteBuffer](/docs/microService/communication/NIO/ByteBuffer.md)  
&emsp; &emsp; [~~Java中的零拷贝~~](/docs/microService/communication/NIO/JavaZeroCopy.md)  
