...
- [1. 子查询](#1-子查询)
    - [1.1. 子查询的位置](#11-子查询的位置)
    - [1.2. 子查询的分类](#12-子查询的分类)
        - [1.2.1. 标量子查询：](#121-标量子查询)
        - [1.2.2. 列子查询：](#122-列子查询)
        - [1.2.3. 行子查询：](#123-行子查询)
    - [1.3. 关键字ALL SOME ANY](#13-关键字all-some-any)
    - [1.4. 关键字In与exists](#14-关键字in与exists)
        - [1.4.1. 关键字In](#141-关键字in)
            - [1.4.1.1. 关键字in与关键字or与关键字between](#1411-关键字in与关键字or与关键字between)
            - [1.4.1.2. 关键字in超过1000个条件的处理](#1412-关键字in超过1000个条件的处理)
        - [1.4.2. 关键字Exists](#142-关键字exists)
        - [1.4.3. In与Exists区别](#143-in与exists区别)
- [2. 连接查询](#2-连接查询)
    - [2.1. 连接类型选择](#21-连接类型选择)
    - [2.2. 自连接](#22-自连接)
        - [2.2.1. 用SQL自连接查询处理列之间的关系](#221-用sql自连接查询处理列之间的关系)
        - [2.2.2. SQL自连接查询表示其它关系](#222-sql自连接查询表示其它关系)
    - [2.3. 子查询与连接查询的区别](#23-子查询与连接查询的区别)
