...
# MySql性能，最大数据量、最大并发数、查询耗时：  
* 最大数据量：  
&emsp; MySQL没有限制单表最大记录数，它取决于操作系统对文件大小的限制。  
![](../images/SQL/sql-28.png)  
...
----
# EXPLAIN、PROCEDURE ANALYSE，(分析)  
## EXPLAIN，分析查询  

```sql
EXPLAIN SELECT column_name FROM table_name;  
```  
![](../images/SQL/sql-29.png)  
