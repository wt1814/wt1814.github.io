...
&emsp; user表：  
![](https://gitee.com/wt1814/pic-host/raw/master/images/SQL/sql-1.png)  
&emsp; order表：  
![](https://gitee.com/wt1814/pic-host/raw/master/images/SQL/sql-2.png)  
...
![](https://gitee.com/wt1814/pic-host/raw/master/images/SQL/sql-3.png)  
2. 将查询到的结果和原有的user表做一个笛卡尔积，结果如下：
![](https://gitee.com/wt1814/pic-host/raw/master/images/SQL/sql-4.png)  
3. 再根据user.id IN order.user_id的条件，将结果进行筛选（既比较id列和user_id 列的值是否相等，将不相等的删除）。最后，得到两条符合条件的数据。
![](https://gitee.com/wt1814/pic-host/raw/master/images/SQL/sql-5.png)  
...
![](https://gitee.com/wt1814/pic-host/raw/master/images/SQL/sql-6.png)  
&emsp; 但是，不一样的是它们的执行流程完全不一样：  
&emsp; 1.使用exists关键字进行查询的时候，首先查询的不是子查询的内容，而是查主查询的表，即先执行的sql语句是：select user.* from user;  
&emsp; 得到的结果如下：  
![](https://gitee.com/wt1814/pic-host/raw/master/images/SQL/sql-7.png)  
...
![](https://gitee.com/wt1814/pic-host/raw/master/images/SQL/sql-9.png)  
![](https://gitee.com/wt1814/pic-host/raw/master/images/SQL/sql-10.png)  
...
![](https://gitee.com/wt1814/pic-host/raw/master/images/SQL/sql-8.png)  
