    ...
    - [2.1. 基本查询语句](#21-基本查询语句)
        ...
        - [2.1.2. 基本查询详解：](#212-基本查询详解)
            ...
            - [2.1.2.3. Like关键字](#2123-like关键字)
                - [2.1.2.3.1. Group By关键字，分组函数，结合聚合函数](#21231-group-by关键字分组函数结合聚合函数)
                - [2.1.2.3.2. Group By 和 Order By和Top](#21232-group-by-和-order-by和top)
                - [2.1.2.3.3. Having关键字与Where的区别](#21233-having关键字与where的区别)
                - [2.1.2.3.4. Group By多字段分组](#21234-group-by多字段分组)
            - [2.1.2.4. Order By关键字](#2124-order-by关键字)
            - [2.1.2.5. Limit，分页](#2125-limit分页)
    - [2.2. 子查询](#22-子查询)
...
```  
##### 2.1.2.3.1. Group By关键字，分组函数，结合聚合函数  
...
##### 2.1.2.3.2. Group By 和 Order By和Top  
