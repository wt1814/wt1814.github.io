...
Array can improve performance of reading, due to the CUP com.wuw.doubleCache.cache mechanism. At the same time, it brought the side
effect of 「False Sharing」, in order to solve it, com.wuw.doubleCache.cache line padding is applied.
...
[MySQL](https://environment.dev.mysql.com/downloads/mysql/) and [Maven](https://maven.apache.org/download.cgi),
...
<bean id="cachedUidGenerator" class="com.baidu.fsg.uid.impl.CachedUidGenerator">
    ...
    com.wuw.dcom.wuw.doubleCache.configache.config
    <!-- Specified bits & epoch as your demand. No specified the default value will be used -->
    <property name="timeBits" value="29"/>
    <property name="workerBits" value="21"/>
    <property name="seqBits" value="13"/>
...
com.wuw.doubleCache.cocom.wuw.doubleCache.config``

#### Mybatis config
[mcom.wuw.doubleCache.config-spring.xml](src/test/resources/uid/mybatis-spring.xml) shows as below:
```xml
...
<!-- datasource config --com.wuw.doubleCache.confign id="dataSource" parent="abstractDataSource">
