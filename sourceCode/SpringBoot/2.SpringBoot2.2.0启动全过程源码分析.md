...
- [1. Spring Boot 2.2.0启动全过程源码分析：](#1-spring-boot-220启动全过程源码分析)
    ...
    - [1.2. SpringApplication 实例 run()方法运行过程](#12-springapplication-实例-run方法运行过程)
        - [1.2.1. 流程解析：](#121-流程解析)
            - [1.2.1.1. 、设置系统属性 `java.awt.headless` 的值](#1211-设置系统属性-javaawtheadless-的值)
            - [1.2.1.2. 、根据运行监听器和应用参数来准备 Spring 环境](#1212-根据运行监听器和应用参数来准备-spring-环境)
            - [1.2.1.3. 、准备应用上下文](#1213-准备应用上下文)
        - [1.2.2. 总结：](#122-总结)
