...
- [1. Spring boot Admin依赖](#1-spring-boot-admin依赖)
    - [1.1. actuator原生端点：](#11-actuator原生端点)
        - [1.1.1. 度量指标类：](#111-度量指标类)
- [2. 在Spring Cloud中基于Eureka的Spring Boot Admin的搭建](#2-在spring-cloud中基于eureka的spring-boot-admin的搭建)
- [3. 监控通知](#3-监控通知)
