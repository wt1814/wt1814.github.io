...
- [5. Redis的API](#5-redis的api)
    - [5.1. Jedis，Java原生](#51-jedisjava原生)
    - [5.2. spring-data-redis](#52-spring-data-redis)
    - [5.3. redis客户端：](#53-redis客户端)
...
## 5.3. redis客户端：
&emsp; Spring Boot 2.x中默认使用lettuce作为默认redis客户端。当然也可以引入redisson客户端。这两种是非阻塞反应式高级redis客户端。建议放弃阻塞客户端jedis。  
