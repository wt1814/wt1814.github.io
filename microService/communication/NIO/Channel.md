...
- [1. NIO通道](#1-nio通道)
    ...
    - [1.2. 分散Scatter/聚集Gather](#12-分散scatter聚集gather)
        - [1.2.1. 分散读取](#121-分散读取)
        - [1.2.2. 聚集写入](#122-聚集写入)
        - [1.2.3. 基本散点/聚集示例](#123-基本散点聚集示例)
        - [1.2.4. 通道之间的数据传输](#124-通道之间的数据传输)
            - [1.2.4.1. FileChannel.transferFrom()方法](#1241-filechanneltransferfrom方法)
            - [1.2.4.2. FileChannel.transferTo()方法](#1242-filechanneltransferto方法)
            - [1.2.4.3. 基本通道到通道数据传输示例](#1243-基本通道到通道数据传输示例)
    - [1.3. 内存映射文件](#13-内存映射文件)
        - [1.3.1. MappedByteBuffer API](#131-mappedbytebuffer-api)
        - [1.3.2. 示例](#132-示例)
    - [1.4. 通道工具类](#14-通道工具类)
...
#### 1.2.4.1. FileChannel.transferFrom()方法  
...
#### 1.2.4.2. FileChannel.transferTo()方法  
