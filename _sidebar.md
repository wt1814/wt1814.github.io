...
* MQ  
    ...
    * [【kafka特性】](/docs/microService/mq/kafka/kafkaCharacteristic.md)  
        ...
        * [【高可用】-如何保证消息队列不丢失?](/docs/microService/mq/kafka/kafkaReliability.md)  
        * [【高可用】-kafka幂等性](/docs/microService/mq/kafka/kafkaIdempotent.md)  
        * [【高可用】-kafka事务](/docs/microService/mq/kafka/kafkaTraction.md)   
