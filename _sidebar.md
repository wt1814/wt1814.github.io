...
* MQ  
    ...
    * [【kafka特性】](/docs/microService/mq/kafka/kafkaCharacteristic.md)  
        ...
        * [【高一致】-如何保证消息队列不丢失?](/docs/microService/mq/kafka/kafkaReliability.md)  
        * [【高一致】-分区保持顺序](/docs/microService/mq/kafka/order.md)  
        * [【高一致】-kafka幂等性](/docs/microService/mq/kafka/kafkaIdempotent.md)  
