...
* [★★★面试流程](/docs/recruit/interview.md)  
...
* ★★★Java基础  
    ...
    * [★★★Java集合框架](/docs/java/Collection/CollectionFramework.md)  
        ...
        * [List和Set](/docs/java/Collection/Collection.md)  
...
* [★★★JVM](/docs/java/JVM/summary.md)  
    ...
    * [★★★GC](/docs/java/JVM/GC.md)  
        ...
        * [跨代引用假说和卡表](/docs/java/JVM/RSet.md)  
...
* [★★★并发编程](/docs/java/concurrent/summary.md)  
    ...
    * [★★★~~线程池-多线程~~](/docs/java/concurrent/ThreadPool.md)  
        ...
        * [★★★线程池的创建](/docs/java/concurrent/ExecutorCreate.md)    
        ...
        * [★★★线程池的执行](/docs/java/concurrent/PoolRun.md)  
        ...
        * [★★★任务执行结果Future](/docs/java/concurrent/Future.md)  
            * [★★★【~~CompletableFuture~~】](/docs/java/concurrent/CompletableFuture.md)  
            * [获取多线程执行结果的几种方式](/docs/java/concurrent/execResult.md)  
...
* [★★★数据库](/docs/SQL/DataBase.md)    
    ...
    * [★★★索引事务锁](/docs/SQL/IndexTransactionLock.md)  
        ...
        * [MySql-MVCC（读写问题）](/docs/SQL/MVCC.md)  
        * [MySql锁（写写问题）](/docs/SQL/lock.md)  
    ...
    * [★★★数据库分布式](/docs/SQL/DistributedDatabase.md)  
        ...
        * [分库分表](/docs/SQL/sub.md)  
            ...
            * [分表id-基因法](/docs/SQL/candidate.md)     
    ...
    * [MySql架构原理](/docs/SQL/MySqlPrinciple.md)    
        ...
        * [存储引擎InnoDB体系结构](/docs/SQL/InnoDB.md)  
        ...
        * [InnoDB磁盘结构-可靠性](/docs/SQL/disk.md)  
            * [redoLog日志](/docs/SQL/redoLog.md)  
            * [undoLog日志](/docs/SQL/undoLog.md)  
...
* [搜索引擎ES](/docs/ES/ES.md)    
    ...
    * [ES原理](/docs/ES/principle.md)  
        ...
        * [★★★~~分词~~](/docs/ES/participle.md)  
        * [★★★~~相关性和打分（排序）~~](/docs/ES/correlation.md)    
...
* ★★★缓存和Redis  
    * [★★★缓存介绍](/docs/cache/Cache.md)  
        ...
        * [二级缓存](/docs/microService/Redis/doubleCache.md)   
            * [j2Cache框架集成Caffeine+Redis二级缓存](/docs/microService/Redis/Caffeine.md)     
        * [★★★分布式缓存问题](/docs/cache/DistributedCache.md)  
            * [查询缓存](/docs/cache/SelectCache.md)  
    ...
    * [★★★Redis](/docs/microService/Redis/RedisSummary.md)   
        ...
        * [★★★Redis数据类型](/docs/microService/Redis/RedisStructure.md)  
            * [Redis基本数据类型](/docs/microService/Redis/RedisBasicStructure.md)  
                * [Zset实现排行榜](/docs/microService/Redis/Leaderboard.md)  
        ...
        * [★★★Redis原理](/docs/microService/Redis/RedisPrinciple.md)  
            * [内存](/docs/microService/Redis/Memory.md)  
                * [Redis内存淘汰（删除哪些数据）](/docs/microService/Redis/RedisEliminate.md)   
                * [Redis过期键删除（删除时机）](/docs/microService/Redis/Keydel.md)  
                * [Redis虚拟内存机制](/docs/microService/Redis/RedisVM.md)    
            * [磁盘](/docs/microService/Redis/Disk.md)    
                * [Redis持久化](/docs/microService/Redis/RedisPersistence.md)  
                    * [AOF重写阻塞](/docs/microService/Redis/Rewrite.md)  
            * [网络](/docs/microService/Redis/Network.md)  
...
* [★★★MQ](/docs/microService/mq/mq.md)    
    ...
    * [★★★kafka特性](/docs/microService/mq/kafka/kafkaCharacteristic.md)  
        ...
        * [【高一致】-kafka幂等性（重复消费）](/docs/microService/mq/kafka/kafkaIdempotent.md)  
        * [【高一致】-kafka事务](/docs/microService/mq/kafka/kafkaTraction.md)   
        * [【高一致】-消息积压](/docs/microService/mq/MessageBacklog.md)  
...
* [★★★分布式事务](/docs/microService/thinking/DistriTransaction.md)  
    * [DTP及XA](/docs/microService/thinking/DTPAndXA.md)  
        * [JTA+Atomic/单体服务多数据源(Spring分布式事务)](/docs/microService/thinking/JTA.md)   
    * [TCC汇总](/docs/microService/thinking/TCCSummary.md)  
...
* [网络IO/分布式通信](/docs/network/NetworkCommunication.md)      
    * [通信基础](/docs/microService/communication/Netty/basics.md)    
        ...
        * [【网络IO】](/docs/microService/communication/NetworkIO.md)  
            ...
            * [I/O模型之I/O多路复用](/docs/microService/communication/Netty/epoll.md)  
    ...
    * [Netty通信框架](/docs/microService/communication/Netty/netty.md)     
...
* ★★★DevOps  
    ...
    * [★★★Kubernetes](/docs/devAndOps/k8s/Kubernetes.md)  
        ...
        * [组件详解](/docs/devAndOps/k8s/assembly.md)  
            ...
            * [k8s网络原理](/docs/devAndOps/k8s/k8snetwork.md)  
            * [k8s共享存储原理](/docs/devAndOps/k8s/k8sSharedStorage.md)  
