...
* Spring  
    ...
    * [SpringIOC解析](/docs/SSM/Spring/SpringIOC.md)  
        ...
        * [手写SpringIOC](/docs/SSM/Spring/HandwrittenIOC.md)  
...
* SpringBoot  
    ...
    * [SpringBoot源码](/docs/microService/SpringBoot/SpringBootSource.md)  
        ...
        * [SpringBoot自动配置](/docs/microService/SpringBoot/AutomaticAssembly.md)  
            * [注解@SpringBootApplication](/docs/microService/SpringBoot/SpringBootApplication.md)  
...
* 分布式缓存
    ...
    * [Redis内置功能](/docs/microService/Redis/BuiltIn.md)  
        ...
        * [RedisKey删除](/docs/microService/Redis/Keydel.md)  
...
* 分布式消息队列
    ...
    * [kafka特性](/docs/microService/mq/kafka/kafkaCharacteristic.md)  
        * [持久化-顺序读写](/docs/microService/mq/kafka/kafkaPersistence.md)  
        * [内存和零拷贝](/docs/microService/mq/kafka/kafkaZeroCopy.md)  
...
* [Netty](/docs/microService/communication/Netty/netty.md)     
    ...
    * [Netty架构剖析](/docs/microService/communication/Netty/Architecture.md)   
