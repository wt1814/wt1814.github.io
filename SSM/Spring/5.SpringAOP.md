...
- [2. SpringAOP](#2-springaop)
    ...
    - [2.2. SpringAOP编码](#22-springaop编码)
        ...
        - [2.2.2. ※※※SpringAOP失效](#222-※※※springaop失效)
            - [2.2.2.1. 解决方案](#2221-解决方案)
                - [2.2.2.1.1. 通过ApplicationContext来获得动态代理对象](#22211-通过applicationcontext来获得动态代理对象)
        - [2.2.3. 切点Execution表达式详解](#223-切点execution表达式详解)
            - [2.2.3.1. 通配符](#2231-通配符)
            - [2.2.3.2. 分类](#2232-分类)
        - [2.2.4. AOP切面传参](#224-aop切面传参)
            - [2.2.4.1. 具体形参类型](#2241-具体形参类型)
            - [2.2.4.2. 不定形参类型](#2242-不定形参类型)
...
#### 2.2.2.1. 解决方案  
##### 2.2.2.1.1. 通过ApplicationContext来获得动态代理对象  
