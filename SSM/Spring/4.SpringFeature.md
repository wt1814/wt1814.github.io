...
- [3. Spring可二次开发常用接口](#3-spring可二次开发常用接口)
    ...
    - [3.2. ApplicationEvent抽象类、ApplicationListener接口](#32-applicationevent抽象类applicationlistener接口)
        - [3.2.1. 使用测试](#321-使用测试)
        - [3.2.2. Spring事件机制解析](#322-spring事件机制解析)
            - [3.2.2.1. ApplicationEvent，事件](#3221-applicationevent事件)
            - [3.2.2.2. ApplicationListener，事件监听器](#3222-applicationlistener事件监听器)
            - [3.2.2.3. ApplicationEventMulticaster，事件管理者](#3223-applicationeventmulticaster事件管理者)
            - [3.2.2.4. ApplicationEventPublisher，事件发布者](#3224-applicationeventpublisher事件发布者)
...
```
#### 3.2.2.2. ApplicationListener，事件监听器  
...
#### 3.2.2.3. ApplicationEventMulticaster，事件管理者  
...
#### 3.2.2.4. ApplicationEventPublisher，事件发布者  
